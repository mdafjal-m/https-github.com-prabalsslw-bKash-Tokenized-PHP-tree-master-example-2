<?php 
	...
	abstract class BkashAbstract
	{
		...
		protected $capture;
		protected $isagreement;
		protected $token;
		protected $callbakurl;
		protected $agreementcallbakurl;
	    ...
	    protected function setIsAgreement($Agreement) {
			$this->isagreement = $Agreement;
		}

		protected function getIsAgreement() {
	    ...
	    protected function setAgreementCallbackUrl($Agreementcallbakurl) {
			$this->agreementcallbakurl = $Agreementcallbakurl;
		}

		protected function getAgreementCallbackUrl() {
	        return $this->agreementcallbakurl;
	    }
